...
export default function RolesSection() {
  ...
  const assassinoLayers = [
    { src: "/Mafia/Mafia-Cards/o-assassino/backgroundAssassino.png", depth: 0.1 },
    { src: "/Mafia/Mafia-Cards/o-assassino/MiddleAssassino.png", depth: 0.6 },
    { src: "/Mafia/Mafia-Cards/o-assassino/TopAssassino.png", depth: 1 },
  ]

  const camponesLayers = [
    { src: "/Mafia/Mafia-Cards/o-campones/backgroundCampones.png", depth: 0.1 },
    { src: "/Mafia/Mafia-Cards/o-campones/MiddleCampones.png", depth: 0.6 },
    { src: "/Mafia/Mafia-Cards/o-campones/TopCampones.png", depth: 1 },
  ]

  const detetiveLayers = [
    { src: "/Mafia/Mafia-Cards/o-detetive/backgroundDetetive.png", depth: 0.1 },
    { src: "/Mafia/Mafia-Cards/o-detetive/MiddleDetetive.png", depth: 0.6 },
    { src: "/Mafia/Mafia-Cards/o-detetive/TopDetetive.png", depth: 1 },
  ]

  const protetoraLayers = [
    { src: "/Mafia/Mafia-Cards/a-protetora/backgroundProtetora.png", depth: 0.1 },
    { src: "/Mafia/Mafia-Cards/a-protetora/MiddleProtetora.png", depth: 0.6 },
    { src: "/Mafia/Mafia-Cards/a-protetora/TopProtetora.png", depth: 1 },
  ]

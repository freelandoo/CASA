...
import { casaFontVars } from "@/lib/fonts"
import { fetchLiveRanking } from "@/lib/casaviews/ranking-live"
import { RankingHeader } from "@/components/acasaviews/ranking/ranking-header"
import { RankingHero } from "@/components/acasaviews/ranking/ranking-hero"
import { PodiumTop3, type PodiumItem } from "@/components/acasaviews/ranking/podium-top3"
import { RankingFilterBar } from "@/components/acasaviews/ranking/ranking-filter-bar"
import { RankingList } from "@/components/acasaviews/ranking/ranking-list"
import { RankingCard } from "@/components/acasaviews/ranking/ranking-card"
import { RankingHighlightNote } from "@/components/acasaviews/ranking/ranking-highlight-note"
import { RankingPageFooter } from "@/components/acasaviews/ranking/ranking-page-footer"
  ...
  return (
    <div className={`${casaFontVars} casa-rank casa-paper min-h-screen overflow-hidden`}>
      ...
      <RankingHeader
        ...
        pageCurrent={9}
        pageTotal={20}
        switchHref="/ranking-participantes"
